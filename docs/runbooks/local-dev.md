...
# API_URL=localhost:8080 (the mock)
# ZONE_CODE=test
...
If the WebSocket reconnect spinner stays on the screen, the mock isn't up — or `API_URL` doesn't match the mock's port. See [running-mock-backend](running-mock-backend.md).
