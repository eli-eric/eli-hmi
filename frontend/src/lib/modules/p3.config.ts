...
export const p3Config: ModuleConfig = {
  heading: 'P3',
  ...
  interlocks: {
    ...
    items: [
      { pvname: 'E3-P3-P3_CHAMBER:INTERLOCK', title: 'P3 Chamber' },
      { pvname: 'E3-P3-CRYO1:INTERLOCK', title: 'P3 Cryopump CRYO1' },
      { pvname: 'E3-P3-CRYO2:INTERLOCK', title: 'P3 Cryopump CRYO2' },
      // TODO PV name unclear
      { pvname: 'L3BT-VCS-EGV501:INTERLOCK', title: 'Valve EGV501' },
      // TODO PV name unclear (legacy code reused EGV501 PV here)
      { pvname: 'L3BT-VCS-EGV501:INTERLOCK', title: 'Valve SGV503' },
    ],
  },
  ...
  safetyPermission: {
    ...
    items: [
      // TODO PV name unclear
      { pvname: 'L3BT_ROUGNING:INTERLOCK', title: 'P3 Chamber Roughing' },
      // TODO PV name unclear
      {
        pvname: 'L3BT_HIGH_VACUUM:INTERLOCK',
        title: 'P3 Chamber High Vacuum Pumping',
      },
      // TODO PV name unclear
      {
        pvname: 'E3-P3-CRYO1_Cooling:INTERLOCK',
        title: 'P3 Cryopump CRYO1 Cooling',
      },
      // TODO PV name unclear
      {
        pvname: 'E3-P3-CRYO2_Cooling:INTERLOCK',
  ...
  roughing: {
    ...
    sensorBar: {
      ...
      label: 'Pressure',
      height: '20rem',
      // TODO PV name unclear (legacy code labelled APG802 PV as APG801)
      sensorPVs: [{ pvName: 'E3-P3-APG802:PRESSURE', label: 'APG801' }],
    },
    pump: {
      title: 'Roughing Pump P000',
      // TODO PVs unknown
      rpmPV: 'AI_RPM_SPEED_P000',
      // TODO PVs unknown
      valvePv: 'BI_PUMP_GV000',
      valveLabel: 'GV000',
    },
    locking: {
