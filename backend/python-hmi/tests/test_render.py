...
from core.epics.types import PvSample
...
from core.render.readouts import bool_readout, number_readout, string_readout
...
class TestTooltip:
    def test_severity_zero_is_the_name_alone(self):
        from core.render.severity import describe_pv
    ...
    def test_invalid_says_what_the_reading_was(self):
        from core.epics.types import LastValid
        from core.render.severity import describe_pv
